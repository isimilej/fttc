...
@Composable
internal fun BaseOutlinedTextField(
    value: String,
...
//                .defaultErrorSemantics(isError, getString(Strings.DefaultErrorMessage))
            ...
            cursorBrush = SolidColor(cursorColor(colors, isError).value),
...
@Composable
private fun cursorColor(colors: TextFieldColors, isError: Boolean): State<Color> {
    return rememberUpdatedState(if (isError) colors.errorCursorColor else colors.cursorColor)
}
